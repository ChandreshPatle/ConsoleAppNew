...
//            Console.WriteLine("Display Call");
...
//            Console.WriteLine($"sb1:{sb1}\ts2:{sb2}");//CDAC INDIA
//            overloadTest.Swap( sb1,  sb2);
//            Console.WriteLine($"sb1:{sb1}\ts2:{sb2}");//INDIA CDAC
//            */
//            /*
...
//            Employee employee1 = new Employee(2000,"Deepti",25500);
//            //Console.WriteLine(employee1);
//            //employee1.DisplayCount();//2,1
//            Employee.DisplayCount();//2

//            Employee employee2 = new Employee(3000, "Sumit");
//            //Console.WriteLine(employee2);
//            //employee2.DisplayCount();//3,1
//            Employee.DisplayCount();//3

//            Employee employee3 = new Employee(4000, _EmpSalary: 50000);
//            //Console.WriteLine(employee3);
//            //employee3.DisplayCount();//4,1

//            //employee.DisplayCount();//4,1
//            Employee.DisplayCount();//4

//            Display();//5
//            Employee employee4 = new Employee(5000, _EmpSalary: 50000);
//            Employee.DisplayCount();//6,5
//            */
